...
$('document').ready(function() {
  ...
  $('.sub-nav-item').each(function() {
    if ($(this).next().is('.sub-sub-nav')) {
      $(this).addClass('sub-arrowed');
    } else {};
  });
  $('.sub-arrowed').click(function() {
    $(this).toggleClass('sub-selected');
    $(this).siblings().removeClass("sub-selected");
    $('.sub-sub-nav').each(function() {
      $(this).slideUp("slow");
    });
    if ($(this).next('.sub-sub-nav').is(':visible')) {
      $(this).next('.sub-sub-nav').slideUp('slow');
    } else {
      $(this).next('.sub-sub-nav').slideDown('slow');
    };
  });
});

<?php the_content(); ?>
    <div class="bg-gradient--opp">
        <div class="subpage-header-logo-container">
            <img src="https://raw.githubusercontent.com/gretzky/arrayo-qa/master/assets/img/header-logos/rtech.png" class="sub-logo rotate">
        </div>
        <div class="wrapper">
        ...
        <div class="line-anim-wrapper hide-on-mobile">
            <div class="line-items-wrapper">
                    ...
                    <div class="line-graphic-wrapper">
                        <svg id="line2" width="1500px" height="162px" viewBox="0 0 1500 162" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <!-- Generator: Sketch 39.1 (31720) - http://www.bohemiancoding.com/sketch -->
                            <title>Page 1</title>
                            <desc>Created with Sketch.</desc>
                            <defs>
                                <radialGradient cx="49.0390625%" cy="50%" fx="49.0390625%" fy="50%" r="55.8389978%" id="radialGradient-1">

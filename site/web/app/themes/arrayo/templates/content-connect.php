<?php the_content(); ?>
    ...
    <div class="subpage-header-logo-container">
            <img src="https://raw.githubusercontent.com/gretzky/arrayo-qa/master/assets/img/header-logos/connect.png" class="sub-logo rotate">
        </div>
        <div class="wrapper">
...
<div class="line-anim-wrapper connect hide-on-mobile">
                    <div class="line-items-wrapper">
                        <img src="http://imgh.us/zigzag-bottom-dot-1.png" class="wow bounceIn bottom-dot first" data-wow-delay=".1s">
                        <img src="http://imgh.us/zigzag-bottom-dot-2.png" class="wow bounceIn bottom-dot second" data-wow-delay=".1s">
                        <img src="http://imgh.us/zigzig-bottom-dot-1.png" class="wow bounceIn mid-dot first" data-wow-delay=".76s">
                        <img src="http://imgh.us/zigzig-bottom-dot-2.png" class="wow bounceIn mid-dot second" data-wow-delay="1.8s">
                        <img src="http://imgh.us/zigzag-ico-1.png" class="wow bounceIn top-dot first" data-wow-delay=".6s">

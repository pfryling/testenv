<?php the_content(); ?>
    ...
    <div class="subpage-header-logo-container">
            <img src="https://raw.githubusercontent.com/gretzky/arrayo-qa/master/assets/img/header-logos/hightech.png" class="sub-logo rotate">
        </div>
        <div class="wrapper">
    ...
    <div class="wrapper">
        <div class="centered-cta-bg centered-cta-bg--hightech wow fadeInUp">
            <p><strong><?php the_field('hightech_slider--intro'); ?></strong></p>
             <img src="https://raw.githubusercontent.com/gretzky/arrayo-qa/master/assets/img/misc-icons/high-tilde.png">

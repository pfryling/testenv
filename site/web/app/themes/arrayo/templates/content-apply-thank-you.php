        ...
        <div class="wrapper">
            <section class="page-header">
                ...
                <div class="moreinfo-wrap">
                    <a class="moreinfobtn" style="color:#ffffff;" href="/apply-more-info">Please provide additional information (optional).<i style="margin-right:30px;color:#ffffff" class="fa fa-arrow-circle-right"></i></a>
                </div>
